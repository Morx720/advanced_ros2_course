...
class MoveToPositionStartup(Node):
    def __init__(self):
        ...
        for node_name in node_name_list:
            ...
            self.cliene_list.append(self.create_client(ChangeState, service_change_state_name))
        
    def change_state(self, transition: Transition):
        for client in self.cliene_list:
